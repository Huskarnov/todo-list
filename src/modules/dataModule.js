...
function initializeLocalStorage(){
    ...
    if(localStorage.getItem("visited") === null){
        ...
        const initialData = JSON.stringify([{   title: "Omelette shopping",
            ...
            dueDate: "2036-11-27",
            checkList: [[false, "buy eggs", 1, 1811022840000],
                        [true, "buy oil", 3, 1811222840000],
                        [false, "buy salt", 1,1813122840000]]
        },
        {   title: "Vegas trip",
            description: "Do things that will stay in vegas",
            dueDate: "2025-07-11",
            checkList: [[false, "do powder", 2, 1512522840000],
                        [false, "cross dress", 3, 1812122840000],
                        [false, "gamble away all savings", 1, 1812722840000]]
        },
        {   title: "Virus upgrade",
            description: "Operate gain of function research",
            dueDate: "2025-03-25",
            checkList: [[false, "modify genes", 3, 1512722840000],
                        [false, "wear hazmat",3, 1812822840000],
                        [true, "inject bats with result", 1, 1812922840000]]
        }
        ]);
